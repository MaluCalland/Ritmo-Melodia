  ...
  return (
    <div>
      ...
      <div> 
        ...
        <p>Alguns dos álbuns mais notáveis de Turma do Pagode incluem:</p>
        <ul>
          <li>"Esse É o Clima (Ao Vivo)" (2010): Inclue músicas como "Camisa 10" e "Selinho".</li>
          <li>"O Som das Multidões (Ao Vivo)" (2012): Com as famosas "Beijo Roubado", "Lancinho" e "Luz, Cama e Ação". </li>
          <li>"Turma do Pagode (Ao Vivo)" (2012): Com destaque para "A Gente Tem Tudo a Ver".</li>
          <li>"Mania do Brasil (Ao Vivo)" (2014): Contém "Pente Rala", "Surpresa de Amor" e "Melhor Amigo". </li>
          <li>"XV Anos (Ao Vivo)" (2016): Álbun que apresenta "Deixa Em Off", "Puxa, Agarra e Beija (part. Aviões do Forró)" e "Vish".</li>
          <p>Além dessas músicas, outras mais tocadas são: "Sua Mãe Vai Me Amar", "Cobertor de Orelha" e "Só Um Pagode".</p>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Turma do Pagode é reconhecida por sua contribuição ao pagode romântico e por popularizar o gênero entre as novas gerações. Eles trouxeram um frescor ao estilo, misturando influências de outros gêneros e criando uma sonoridade própria. Seu legado se reflete na maneira como influenciaram novos artistas e na continuidade do pagode como um gênero relevante na música brasileira. Com uma carreira marcada por sucessos e uma base de fãs leal, Turma do Pagode continua a ser um dos nomes mais importantes do pagode, celebrando a cultura e a alegria do samba.</p>
      </div>
      <div>
        <h3> Deixa em Off  - Turma do Pagode</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/x_uuWhEtm4k"
            title="Canção Deixa em Off "
      ...
      <div> 
        ...
        <h3>História na Música</h3>
        <p>Sorriso Maroto começou sua trajetória musical em festas e eventos, e logo se tornou conhecido na cena do pagode carioca. Em 2000, lançaram seu primeiro álbum, que os catapultou ao sucesso. Com uma mistura de ritmos e uma proposta musical que falava sobre amor e relacionamentos, o grupo foi um dos responsáveis por popularizar o pagode romântico no Brasil.</p>
        <h3>Principais Álbuns e Músicas Famosas</h3>
        <p>Alguns dos álbuns mais notáveis de Sorriso Maroto incluem:</p>
        <ul>
          <li>"Ao Cubo, Ao Vivo, Em Cores" (2019): Álbun que apresenta "Outros Ideais" e "Escondido Dos Seus Pais". </li>
          <li>"Ensaio Aberto - AMA" (2020):  Com destaque para "Sinal Vital". </li>
          <li>"Juntos (part. Dilsinho)" (2022): Inclue músicas como "Terra de Ninguém" e "Mensagem Apagada". </li>
          <li>"Como Antigamente (Ao Vivo)" (2022): Apresenta "Como Antigamente", "Segredos" e "Amuleto". </li>
          <li>"Sorriso Eu Gosto No Pagode (Ao Vivo)" (2023): Contém "Ainda Gosto de Você / Já Era" e "Coração Deserto / Ninguém Merece Amar Sozinho / a Primeira Namorada"</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Sorriso Maroto é reconhecido por sua contribuição significativa ao pagode romântico e por renovar o gênero com letras que falam diretamente ao coração dos ouvintes. O grupo influenciou uma nova geração de artistas e ajudou a popularizar o pagode em diversas regiões do Brasil. Seu legado é notável, pois eles continuam a atrair novas audiências e a se apresentar em grandes festivais e eventos. Com uma carreira marcada por sucessos e uma base de fãs fiel, Sorriso Maroto permanece como uma das principais referências do pagode, celebrando o amor e a alegria em sua música.</p>
      </div>
      <div>
        <h3>Escondido Dos Seus Pais -  Sorriso Maroto</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/zoTUuA5FvrI"
            title="Canção Escondido Dos Seus Pais"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
