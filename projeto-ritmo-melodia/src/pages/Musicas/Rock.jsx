    ...
    <div>
      ...
      <div >
        ...
        <ul>
          ...
          <li>"Hoje" (1981): Destaca "Ovelha Negra" e "Doce, Doce Amor".</li>
          <li>"Rita Lee e Roberto de Carvalho" (1984): Com a conhecida "Amor e Sexo".</li>
          <li>"Levava" (1993): Um álbum que reúne diversos hits, como "Dançando no Campo".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Rita Lee é reconhecida não apenas por sua música, mas também por sua postura autêntica e sua capacidade de quebrar tabus. Ela foi uma das primeiras mulheres a se destacar em um cenário predominantemente masculino no rock brasileiro. Sua carreira abrange mais de cinco décadas, e ela continua a ser uma figura relevante na cultura brasileira, influenciando novas gerações de artistas e fãs.</p>
      </div>
      <div>
        <h3>Mania de Você - Rita Lee Feat. Milton Nascimento</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/32L_EJpg4Lw"
            title="Canção Mania de Você "
      ...
      <div >
        ...
        <ul>
          ...
          <li>"Como Tudo Deve Ser" (2002): Inclui múicas como "É Tudo Seu" e "Um Dia A Gente Se Encontra"</li>
          <li>"Ritmo, Ritual e Responsa" (2005): Inclui múicas como "Lutar Pelo Que É Meu" e "Sábado à Noite"</li>
          <li>"La Familia 013" (2013): Inclui múicas como "Te Levar" e "Sorrindo Pra Dentro"</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Charlie Brown Jr. é considerado uma das bandas mais influentes do rock brasileiro. Suas letras refletem a realidade de muitos jovens, abordando temas de rebeldia, amor e desafios sociais. A banda ajudou a popularizar um estilo que mistura rock com ritmos brasileiros e influências do rap, criando um som único. O legado de Charlie Brown Jr. permanece vivo, mesmo após a morte de Chorão em 2013. A banda continua a ser admirada por suas canções atemporais e pela capacidade de se conectar com diversas gerações. Seu impacto na música brasileira é inegável, e suas músicas ainda são amplamente tocadas e lembradas, reafirmando seu lugar na história do rock nacional.</p>
      </div>
      <div>
        <h3>Proibida Pra Mim - Charlie Brown Jr.</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/liUFyz_sXLE"
            title="Canção Proibida Pra Mim"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div >
        ...
        <ul>
          ...
          <li>"Setevidas" (2014) - "Noite", "Te Contei?", "Cazuza".</li>
          <li>"Matriz" (2019) - "Noite", "Amor de Sábado", "Sorriso".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Pitty é uma figura emblemática no rock brasileiro, conhecida por sua autenticidade e por ser uma voz forte em questões de gênero e empoderamento feminino. Ela quebrou estereótipos e se tornou um ícone, especialmente entre o público jovem. Seu legado é marcado pela inovação e pela capacidade de conectar-se com as emoções do público, fazendo de suas músicas um reflexo de experiências reais. Com uma carreira sólida e influente, Pitty continua a inspirar novos artistas e a impactar a cena musical brasileira, mantendo sua relevância ao longo dos anos.</p>
      </div>
      <div>
        <h3>Equalize - Pitty</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/x7WHL-o5tMo"
            title="Canção Equalize "
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div >
        ...
        <ul>
          ...
          <li>"Instinto Coletivo" (2001): Destaca  "Minha Alma (A Paz que Eu Não Tenho)".</li>
          <li>"7 Vidas" (2003): Com a conhecida "Anjos".</li>
          <li>"Acústico" (2005): Um álbum que reúne diversos hits, como "A Feira" (acústica).</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>O Rappa é considerado um dos pilares do rock brasileiro contemporâneo, sendo reconhecido por sua habilidade em misturar diferentes estilos musicais e por suas letras impactantes que abordam questões sociais. A banda deixou um legado duradouro na cena musical, inspirando novos artistas e movimentando discussões sobre realidades sociais no Brasil. Sua música continua a ser relevante e ressoa com muitas gerações, fazendo de O Rappa uma referência importante na cultura musical do país.</p>
      </div>
      <div>
        <h3>Minha Alma (A Paz que Eu Não Tenho) - O Rappa</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/vF1Ad3hrdzY"
            title="Canção Minha Alma (A Paz que Eu Não Tenho)"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div >
        ...
        <ul>
          ...
          <li>Como Eu Posso Não Falar de Amor (1989): Destaca "Primeiros Erros" e "À Sua Maneira".</li>
          <li>Raio X (2003): Com a conhecida "O Sol".</li>
          <li>Sonhos e Memórias (2019): Um álbum que reúne diversos hits, como: "Amanhã" (feat. Luiza Possi).</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Capital Inicial é considerado um dos ícones do rock brasileiro, contribuindo significativamente para a popularização do gênero no país. Suas músicas, que misturam rock com letras poéticas e críticas, ressoam com diversas gerações. O legado da banda é marcado pela habilidade em se reinventar e pela relevância contínua de suas canções na cena musical brasileira, mantendo um público fiel e ativo ao longo dos anos.</p>
      </div>
      <div>
        <h3>Primeiros Erros - Capital Inicial</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/jabmx3QoJGA"
            title="Canção Primeiros Erros "
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div >
        ...
        <ul>
          ...
          <li>Que País É Este (1987): Destaca "Que País É Este" e "Geração Coca-Cola".</li>
          <li>As Quatro Estações (1989): Com a conhecida "Pais e Filhos".</li>
          <li>O Descobrimento do Brasil (1993): Um álbum que reúne diversos hits, como "A Dança" e "Perfeição".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>A Legião Urbana é amplamente reconhecida por sua influência na música brasileira e por suas letras que abordam temas sociais, existenciais e políticos. Renato Russo se tornou um ícone cultural, e suas composições são estudadas e apreciadas por várias gerações. O legado da banda é profundo, tendo inspirado inúmeros artistas e movimentos musicais. Mesmo após o fim da banda, sua música permanece relevante, com shows tributo e reinterpretações. A Legião Urbana continua a ser uma referência no rock brasileiro, simbolizando uma época e um sentimento coletivo que ainda ecoa na cultura do país.</p>
      </div>
      <div>
        <h3>Pais e Filhos - Legião Urbana</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/bvIMBVBRpJU"
            title="Canção Pais e Filhos "
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div >
        ...
        <ul>
          ...
          <li>Durex (1986): Destaca "Lanterna dos Afogados" e "Aonde Quer Que Eu Vá".</li>
          <li>Selvagem (1991): Com a conhecida "Teorema".</li>
          <li>Longo Caminho (1999): Um álbum que reúne diversos hits, como "Caleidoscópio".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Os Paralamas do Sucesso são reconhecidos por sua contribuição significativa ao rock brasileiro e à música popular. Eles ajudaram a consolidar o rock nacional nos anos 80 e 90, com letras que refletem as inquietações sociais e políticas do Brasil. A banda é famosa por suas performances enérgicas e pela qualidade de suas composições. O legado dos Paralamas é profundo, com uma discografia rica e uma base de fãs fiel. Eles continuam a influenciar novas gerações de músicos e permanecem ativos na cena musical, realizando shows e lançando novas músicas. A capacidade da banda de misturar estilos e de se reinventar ao longo do tempo consolidou sua posição como um dos pilares do rock brasileiro.</p>
      </div>
      <div>
        <h3>Aonde Quer Que Eu Vá - Paralamas do Sucesso</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/ZZmOVlCSCt8"
            title="Canção Aonde Quer Que Eu Vá"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div >
        <h2 className="cantores">Engenheiros do Hawaii</h2>
        <p>Engenheiros do Hawaii é uma banda de rock brasileira formada em 1985, em Porto Alegre, Rio Grande do Sul. A banda foi criada por Humberto Gessinger (vocal e guitarra), e a formação clássica incluía também o baixista Felipe Lemos, o baterista Peco ou Peco (Peco ou Pepeco) e o guitarrista Marcos Lessa. Desde o início, os Engenheiros se destacaram por suas letras poéticas e melódicas, que abordam temas como amor, solidão e questões sociais.</p>
        <h3>História na Música</h3>
        ...
        <ul>
          ...
          <li>Engenheiros do Hawaii (1992): Destaca "O Dia em que a Terra Parou" e "Sopa".</li>
          <li>Novos Horizontes (1995): Com a conhecida "O Dia em que a Terra Parou".</li>
          <li>Ao Vivo (2000): Um álbum que reúne diversos hits, como "Era um Garoto que Como Eu Amava os Beatles e os Rolling Stones".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Os Engenheiros do Hawaii são amplamente reconhecidos por sua contribuição ao rock brasileiro, sendo uma das bandas mais queridas do país. Suas letras, frequentemente poéticas e filosóficas, abordam temas que ressoam profundamente com o público. A capacidade de Humberto Gessinger de mesclar melodias envolventes com letras significativas consolidou a banda como uma referência no cenário musical. O legado dos Engenheiros do Hawaii é evidente na influência que tiveram sobre novos artistas e na fidelidade de sua base de fãs. A banda continua ativa, realizando shows e lançando novas músicas, mantendo-se relevante e conectada ao público, mesmo após décadas de carreira.</p>
      </div>
      <div>
        <h3>Infinita Highway - Engenheiros do Hawaii</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/jLdAuGarfM0"
            title="Canção Infinita Highway "
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div >
        <h2 className="cantores">Barão Vermelho </h2>
        <p>Barão Vermelho é uma banda de rock brasileira formada em 1981, no Rio de Janeiro. A banda é conhecida por sua mistura de rock, blues e influências da música brasileira. Os integrantes fundadores incluem Cazuza (vocal), Frejat (guitarra), Dé Ribeiro (baixo), Maurício Barros (teclados) e P defeito (bateria). Desde o início, o Barão Vermelho se destacou por suas letras marcantes e performances enérgicas.</p>
        <h3>História na Música</h3>
        ...
        <ul>
          ...
          <li>Carnaval (1986): Destaca "Pense e Dance" e "O Amor Não É Fogo Que Se Apaga".</li>
          <li>Barão Ao Vivo (1990): Com a conhecida "Exagerado".</li>
          <li>O Passo do Lui (1994): Um álbum que reúne diversos hits, como "Por Que Não Eu?".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Barão Vermelho é amplamente reconhecido por sua contribuição ao rock brasileiro, sendo uma das bandas mais emblemáticas do gênero. Suas letras, que muitas vezes abordam amor, rebeldia e questões sociais, ressoam profundamente com o público. O legado do Barão Vermelho é evidente na influência que exerceram sobre novas gerações de músicos e na fidelidade de seus fãs. A banda continua a se apresentar e a lançar novos trabalhos, mantendo-se relevante na música brasileira. A combinação de talento musical, letras impactantes e uma presença de palco vibrante consolidou o Barão Vermelho como um ícone do rock nacional.</p>
      </div>
      <div>
        <h3>Bete Balanço - Barão Vermelho</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/blIlWZkh5io"
            title="Canção Bete Balanço "
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      <div >
        ...
        <ul>
          ...
          <li>Farpa (1996): Destaca "Ainda Bem" e "Sutilmente".</li>
          <li>Cosmotron (2003): Com a conhecida "Mandrágora".</li>
          <li>Estandarte (2007): Um álbum que reúne diversos hits, como "Sabor de Mel".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>O Skank é amplamente reconhecido por sua contribuição à música brasileira, especialmente na popularização de ritmos como reggae e ska no rock nacional. Suas letras frequentemente abordam temas de amor, sociedade e cotidiano, ressoando com uma ampla audiência. O legado do Skank é evidente na influência que a banda exerceu sobre novos artistas e na fidelidade de seus fãs. Com uma discografia rica e uma presença de palco vibrante, o Skank continua a se apresentar e a lançar novas músicas, mantendo-se relevante na cena musical brasileira por mais de três décadas. A capacidade de misturar diferentes estilos e a qualidade das composições solidificaram sua posição como um dos pilares da música popular brasileira.</p>
      </div>
      <div>
        <h3> Sutilmente- Skank</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/v3SQTOZO36E"
            title="Canção Sutilmente "
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
