...
const Axe = () => {
  return (
    <div className='divMusicas'>
      <h1 className='tituloPaginaMusicas'>Artistas do Axé</h1>
      <div> 
        ...
        <p>Alguns dos álbuns mais significativos de Ivete Sangalo incluem:</p>
        <ul>
          <li>"Ivete Sangalo" (1999): Seu álbum de estreia solo, com hits como "Sorte Grande".</li>
          <li>"Todo Mundo Foi" (2000): Inclui "Festa" e "Acelera Aê".</li>
          <li>"Live in Copacabana" (2004): Um álbum ao vivo que captura sua energia, com músicas como "Coração Radical".</li>
          <li>"As Super Novas" (2007): Destaca "Beijo no Coração" e "No Dela".</li>
          <li>"Real Fantasia" (2010): Com sucessos como "Não Quero Dinheiro (Só Quero Amar)".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Ivete Sangalo é conhecida por sua habilidade de conectar-se com o público e por sua presença de palco vibrante. Ela é uma das artistas mais premiadas do Brasil, com vários prêmios e reconhecimentos ao longo de sua carreira. Seu estilo único e suas canções contagiantes contribuíram significativamente para a popularização do axé e do carnaval, tornando-a uma verdadeira lenda da música brasileira. Além disso, Ivete é um ícone cultural, reconhecida por seu engajamento em causas sociais e sua influência positiva.</p>
      </div>
      <div>
        <h3>Sorte Grande - Ivete Sangalo</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/dDQZrIb4kFw"
            title="Canção Sorte Grande"
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"Se Eu Não Te Amasse Tanto Assim" (2011): Com a famosa faixa-título e "Mistura do Pôr do Sol".</li>
          <li>"Claudia Leitte - Acústico" (2015): Um álbum ao vivo que apresenta versões intimistas de seus sucessos.</li>
          <li>"Estado de Poesia" (2018): Com canções como "Perigosas" e "Baldio".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Cláudia Leitte é conhecida por sua presença de palco e performances energéticas, especialmente durante o carnaval, onde atrai multidões. Ela tem sido uma voz influente na música brasileira, promovendo o axé em diversas plataformas, inclusive internacionalmente. Ao longo de sua carreira, recebeu numerosos prêmios e reconhecimentos, solidificando seu status como uma das grandes artistas da música popular brasileira. Além de sua carreira musical, Cláudia também é reconhecida por seu engajamento em causas sociais e humanitárias.</p>
      </div>
      <div>
        <h3>Bola De Sabão - Claudia Leitte</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/ZOrA7lPZPR8"
            title="Canção Bola de Sabão"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"Festa do Interior" (1997): Apresenta "Bebendo Água de Coco".</li>
          <li>"Sambas de Enredo" (1999): Um álbum com várias interpretações de sambas de enredo conhecidos.</li>
          <li>"Banda Eva ao Vivo" (2000): Um registro ao vivo que captura a energia da banda em apresentações.</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>A Banda Eva é reconhecida por sua contribuição ao gênero axé, trazendo um repertório que combina elementos do samba, pop e rock, sempre com uma pegada festiva. Mesmo com mudanças de formação e vocalistas ao longo dos anos, a banda continua a ser uma força importante na música brasileira, especialmente no carnaval, onde suas músicas são um convite à dança e à celebração. A Banda Eva permanece um símbolo da cultura baiana e uma referência no cenário musical nacional.</p>
      </div>
      <div>
        <h3>Eva - Banda Eva</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/G-USuS2HHkY"
            title="Canção Eva"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"Tchan ao Vivo" (1997): Um álbum ao vivo que captura a energia das apresentações do grupo.</li>
          <li>"O Mundo é Tchan" (1998): Com sucessos como "Tchan na Selva".</li>
          <li>"É o Tchan no Brasil" (2000): Inclui "Dança do Ventre".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>É o Tchan é amplamente reconhecido por seu papel na popularização do axé music e por sua influência nas festas de carnaval. As coreografias da banda se tornaram icônicas, e suas músicas continuam a ser tocadas em eventos festivos em todo o Brasil. Mesmo com mudanças na formação ao longo dos anos, o grupo permanece uma referência no cenário musical, celebrando a cultura e a alegria do carnaval brasileiro.</p>
      </div>
      <div>
        <h3>Na Boquinha Da Garrafa - É O Tchan</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/vo1oHGUNfyU"
            title="Canção Na Boquinha Da Garrafa"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"Leo Santana - Ao Vivo em Salvador" (2020): Um álbum ao vivo que apresenta suas principais canções.</li>
          <li>"O Mundo é Leo" (2021): Com faixas como "Parece que o Mundo Acabou" e "Onda do Verão".</li>
          <li>"Levada Do Gigante (Ao Vivo)": Com músicas como "Contatinho (ao vivo)", ao lado de Anitta.</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Léo Santana é conhecido por sua capacidade de animar o público e por seu estilo único, que mistura axé, pagode e pop. Ele tem conquistado prêmios e reconhecimentos por sua música e performances ao longo da carreira. Com uma base de fãs crescente, Léo continua a ser uma figura influente na música brasileira, trazendo alegria e celebração ao cenário musical, especialmente durante o carnaval.</p>
      </div>
      <div>
        <h3>Santinha - Léo Santana</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/GBteTh-ft38"
            title="Canção Santinha"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"O Melhor de Jammil" (2006): Uma coletânea de sucessos.</li>
          <li>"Depois do Carnaval" (2011): Apresenta "Vem Dançar" e "Deixa Eu Te Amar".</li>
          <li>"A Gente Faz a Festa" (2015): Com músicas animadas que capturam a essência do carnaval.</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Jammil e Uma Noites é reconhecida por sua habilidade de criar um ambiente festivo e contagiante, especialmente durante o carnaval. O grupo continua a ser uma referência no cenário do axé, atraindo um público diversificado com suas performances energéticas e repertório inovador. Ao longo dos anos, a banda tem contribuído significativamente para a música brasileira, mantendo viva a tradição do axé e celebrando a cultura baiana.</p>
      </div>
      <div>
        <h3>Milla - Jammil e Uma Noites</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/ZjHXDQryUnI"
            title="Canção Milla"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"Tô de Pé" (1994): Inclui "Me Abraça" e "Caminho da Roça".</li>
          <li>"A Banda" (2000): Apresenta "Sorrindo pra Dentro" e "O Sol".</li>
          <li>"Viva a Folia" (2007): Com a famosa "Chicleteiro".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"Ao Vivo em Salvador" (2010): Um álbum ao vivo com muitos dos sucessos da banda.</li>
          <li>"Parangolé" (2013): Com hits como "Alo, Alo, Brasil" e "Mestre do Riso".</li>
          <li>"Só Deixa Eu Te Amar" (2018): Inclui músicas como "Onda do Verão" e "Tô de Pé".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Parangolé é reconhecida por sua capacidade de animar o público e criar um ambiente festivo em suas apresentações. A banda ajudou a popularizar o axé e o pagode na Bahia e em todo o Brasil, contribuindo para a cultura do carnaval. Embora Léo Santana tenha saído da banda em 2016 para seguir carreira solo, o Parangolé continua a ser uma força relevante na música brasileira, trazendo alegria e diversão em suas performances.</p>
      </div>
      <div>
        <h3>Rebolation - Parangolé</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/X9P2d5lF2l4"
            title="Canção Rebolation "
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"Coração de Luto" (2008): Apresenta "A Bêbada" e outras faixas animadas.</li>
          <li>"Eletro Psirico" (2013): Com sucessos como "Lepo Lepo" e "O Lobo Mau".</li>
          <li>"Psirico 10 Anos" (2014): Uma celebração dos 10 anos de carreira, com novos hits.</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Psirico é reconhecida por sua contribuição significativa ao gênero axé e ao carnaval, trazendo uma energia contagiante a suas performances. A banda continua a se reinventar e a atrair novas gerações de fãs, mantendo viva a tradição da música baiana. Seus sucessos são frequentemente tocados em festas e eventos, consolidando seu legado no cenário musical brasileiro.</p>
      </div>
      <div>
        <h3>Lepo Lepo - Psirico</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/AHVS5DW434g"
            title="Canção Lepo Lepo"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
      ...
      <div> 
        ...
        <ul>
          ...
          <li>"Ao Vivo" (2004): Um registro de suas apresentações ao vivo, destacando várias de suas músicas.</li>
          <li>"Harmonia do Samba – 10 Anos" (2006): Celebração da década de carreira com novos hits.</li>
          <li>"Coração de Estudante" (2010): Inclui músicas como "Ame-O ou Deixe-O".</li>
        </ul>
        <h3>Contribuições e Legado</h3>
        <p>Harmonia do Samba é reconhecida por sua capacidade de criar um ambiente festivo e animado, especialmente durante o carnaval. O grupo tem sido uma referência no cenário do axé, ajudando a popularizar o gênero e contribuindo para a cultura musical da Bahia. Com seu estilo único e carisma, a banda continua a encantar o público, solidificando seu legado na música brasileira.</p>
      </div>
      <div>
        <h3>Nova Paradinha - Harmonia do Samba</h3>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/iXd5SxCGFV4"
            title="Canção Nova Paradinha "
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
          ></iframe>
      </div>
